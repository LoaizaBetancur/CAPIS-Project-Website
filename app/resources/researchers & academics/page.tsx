...
export const metadata: Metadata = {
  ...
  description: "Information sheets and resources for researchers and academics taking part in the CAPIS project.",
  openGraph: {
    title: "Resources for Researchers & Academics | The CAPIS Project",
    description: "Information sheets and resources for researchers and academics taking part in the CAPIS project.",
        ...
        >
          ...
          >
            <div style={{ position: "relative", width: "280px", height: "200px" }}>
              <Image
                src="/images/players.pic6.jpg"
                alt="Football researchers and players"
                fill
